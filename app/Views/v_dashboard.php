...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="<?= base_url() ?>/public/images/deskapp-logo.svg" alt=""></div>
	...
	<div class="header">
		...
		<div class="header-right">
			...
			<div class="github-link">
				<a href="https://github.com/dropways/deskapp" target="_blank"><img src="<?= base_url() ?>/public/images/github.svg" alt=""></a>
			</div>
		</div>
	</div>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
				<img src="<?= base_url() ?>/public/images/deskapp-logo.svg" alt="" class="dark-logo">
				<img src="<?= base_url() ?>/public/images/deskapp-logo-white.svg" alt="" class="light-logo">
			</a>
		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4">
						<img src="<?= base_url() ?>/public/images/banner-img.png" alt="">
					</div>
					<div class="col-md-8">
			...
			<div class="card-box mb-30">
				...
				<table class="data-table table nowrap">
					...
					<tbody>
						<tr>
							<td class="table-plus">
								<img src="<?= base_url() ?>/public/images/product-1.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="<?= base_url() ?>/public/images/product-2.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="<?= base_url() ?>/public/images/product-3.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="<?= base_url() ?>/public/images/product-4.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="<?= base_url() ?>/public/images/product-5.jpg" width="70" height="70" alt="">
							</td>
							<td>
